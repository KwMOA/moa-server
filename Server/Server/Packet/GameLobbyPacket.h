...
#pragma pack(push, 1)
    ...
    struct SinglePlayReqPacket : public Packet
    {
        SinglePlayReqPacket() { cmd = SINGLE_PLAY_REQ; }
    ...
    struct SinglePlayResPacket : public Packet
    {
        SinglePlayResPacket() { cmd = SINGLE_PLAY_RES; }
        
        int64_t userNo;
    };
    
    struct SinglePlayOkPacket : public Packet
    {
        SinglePlayOkPacket() { cmd = SINGLE_PLAY_OK; }
        
        int64_t userNo;
    };
    
    struct SinglePlayOutPacket : public Packet
    {
        SinglePlayOutPacket() { cmd = SINGLE_PLAY_OUT; }
