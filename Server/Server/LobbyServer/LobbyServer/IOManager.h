...
//    void frontHandleGetRoomListReq(ConnectInfo* connectInfo, const char* body, const int bodySize);
    ...
    void gameHandleSinglePlayRes(ConnectInfo* connectInfo, const char* body, int bodySize);
    ...
    void clientHandleSinglePlayReq(ConnectInfo* connectInfo, const char* body, const int bodySize);
