...
public:
    ...
    bool isAiMode() { return isAM; }
    void setAiMode(bool _isAM) { isAM = _isAM; }
    
    int getAiModeTribe() { return aiModeTribe; }
    void setAiModeTribe(int _aiModeTribe) { aiModeTribe = _aiModeTribe; }
    
    int16_t getAiModeStageNo() { return aiModeStageNo; }
    void setAiModeStageNo(int _aiModeStageNo) { aiModeStageNo = _aiModeStageNo; }
